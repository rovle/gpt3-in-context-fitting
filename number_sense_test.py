"""
To test how much does some kind of "number sense" influence GPT-3's
classifications, versus just shallow patern matching on symbols,
Here I'll map digits 0, ..., 9 in the feature vector to some
random letters, and see how that affects classification accuracy.

Comparison on experiments 3-6 (inclusive).
